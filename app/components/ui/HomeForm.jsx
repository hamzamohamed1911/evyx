...
const HomeForm = () => {
  ...
  return (
    <div className="md:w-[398px] w-[388px] md:h-[370px] h-[350px] lg:p-7 md:p-5 p-4 bg-[#2F4E8E] bg-opacity-70 relative rounded-lg shadow-lg text-white">
      <h1 className="lg:text-3xl md:text-2xl text-xl font-bold lg:my-5 md:my-3 sm:my-2 my-1">تواصل معنا</h1>
      <form
        name="contact-form"
        method="post"
