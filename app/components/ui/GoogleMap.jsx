      ...
      <div className="absolute right-0 bottom-0 bg-[#DB965E] w-full xl:w-[452px]  md:w-[300px] h-auto rounded-md text-[#2F4E8E] text-base md:text-md lg:text-2xl p-4 lg:p-8">
        <div className="mb-2 md:mb-3 lg:mb-4">
          <h1>
            ...
            <a href="tel:+201500002077" className="underline ml-1">
              00201500002077
            </a>
          </h1>
        </div>
        <div className="mb-2 md:mb-3 lg:mb-4">
          <h1>
            ...
            <a href="mailto:info@evyx.net" className="underline ml-1">
              info@evyx.net
            </a>
          </h1>
        </div>
        <div className="mb-2 md:mb-3 lg:mb-4">
          <h1>
            ...
            <a
              href="https://maps.google.com/?q=36 شارع البطراوى من عباس العقاد مدينة نصر"
              className="underline ml-1"
            >
              36 شارع البطراوى من عباس العقاد مدينة نصر
            </a>
          </h1>
        </div>
        <div className="mb-2 md:mb-3 lg:mb-4">
          <h1>
            {" "}
            <strong> العنوان في لندن: </strong>{" "}
            <a
              href="https://maps.google.com/?q=7 Coronation Road, Dephna House, Launchese, London, United Kingdom, NW10 7PQ"
              className="underline ml-1"
            >
              7 Coronation Road, Dephna House, Launchese, London, United
              Kingdom, NW10 7PQ
            </a>
          </h1>
        </div>
