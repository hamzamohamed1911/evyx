    ...
    <section id='عن-ايڤكس' className="mx-auto container p-6 py-10 ">
      <div className="flex flex-col md:flex-row lg:gap-10 gap-4 items-center">
        ...
        <div className="flex flex-col justify-center items-start lg:p-10 w-full md:w-1/2">
          ...
          <p className="md:text-3xl text-xl lg:text-4xl my-6 leading-relaxed lg:leading-normal">
          ...
          <Link href="#احصل-على-عرض" className="px-6 py-3 gap-2 flex items-center bg-[#DB965E] text-white font-medium rounded-md hover:bg-[#f2a86c] transition duration-300">
