      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-5 py-5 justify-items-center'>
        <div className=' w-full flex flex-col items-center'>
          <div className='border-2 border-black rounded-md'>
            <Image src={ecommerce} alt='ecommerce' width={300} height={200} className='w-full' />
          </div>
        ...
        <div className=' w-full flex flex-col items-center'>
          <div className='border-2 border-black rounded-md'>
            <Image src={landingPage} alt='landingPage' width={300} height={200} className='w-full' />
          </div>
        ...
        <div className=' w-full flex flex-col items-center'>
          <div className='border-2 border-black rounded-md'>
            <Image src={wordPress} alt='wordPress' width={300} height={200} className='w-full'  />
          </div>
