...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center bg-gray-100">
      ...
      <h2 className="text-2xl mt-4">لم يتم العثور على الصفحة</h2>
      <p className="text-xl lg:text-3xl font-bold leading-relaxed lg:leading-normal mb-10">تعذر العثور على المورد المطلوب.</p>
